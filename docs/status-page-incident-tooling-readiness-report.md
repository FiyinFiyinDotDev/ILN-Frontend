...
| #935  | Incident history view with resolution times                        | Open     | Users cannot see reliability history beyond what Instatus shows                                                                                                 |
| #936  | Status-page health wired into shared alert routing                 | Open     | No shared alerting path with the backend repo                                                                                                                   |
| #937  | Subscriber notifications for incidents (email/webhook opt-in)      | Open     | Proactive notice relies on Instatus's built-in subscribers                                                                                                      |
| #938  | Synthetic end-to-end canary feeding the status page                | Open     | No scheduled browser journey feeds component health                                                                                                             |
